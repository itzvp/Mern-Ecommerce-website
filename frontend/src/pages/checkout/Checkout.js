...
import { Helmet } from "react-helmet";
import { Input, Stack, Select, Image, Link } from "@chakra-ui/react";
import { RiShoppingCart2Line } from "react-icons/ri"; // Corrected import path
import "./checkout.css";
import {
  saveAddressshipping,
  savepaymentmethod,
      ...
      <div className="limit-check">
        <div className="info-check">
          <form onSubmit={handleOrder}>
            <div className="billing-check">
              <h1>Billing Address</h1>
              <label className="this-label">Address</label>
              <br />
              <Input
                variant="flushed"
              ...
              <div className="city-cp-check">
                <div>
                  <label className="this-label">City</label>
                  <Input
                    variant="flushed"
                    required
                ...
                <div>
                  <label className="this-label">Zip</label>
                  <Input
                    variant="flushed"
                    required
